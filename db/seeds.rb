...
recipes = [
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1650143987591-8e2d4231a8d6?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1676300184847-4ee4030409c0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1621188988909-fbef0a88dc04?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    name: "Club sandwich",
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1623174554836-e8420d3198c2?q=80&w=1035&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    name: "Bowl d'hiver",
    ...
    image_url: "https://images.unsplash.com/photo-1567575990843-105a1c70d76e?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    name: "Lasagne",
    ...
    image_url: "https://images.unsplash.com/photo-1574894709920-11b28e7367e3?q=80&w=1035&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1591271955631-f6167c3d3564?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    name: "Avocado toast",
    ...
    image_url: "https://images.unsplash.com/photo-1504382262782-5b4ece78642b?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
    ...
    image_url: "https://api.toutlevin.com/images/0819b1309d01a611dec007fae87e57a7004740003000.jpg?width=1920&quality=75"
  },
  {
    name: "Chakchouka",
    ...
    image_url: "https://images.unsplash.com/photo-1542895364-1f38d277f031?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  },
  {
  ...
  },
  {
    ...
    image_url: "https://www.gourmandiseries.fr/wp-content/uploads/2018/12/ravioles-truffes-ecume-poireau.jpg"
  },
  {
...
ingredients = [
  ...
  { name: "Pain burger", prix_au_kilo: 4 },
  ...
  { name: "Feuille de nori", prix_au_kilo: 180 },
  { name: "Mozzarella", prix_au_kilo: 8 },
  { name: "Persil", prix_au_kilo: 140 },
  { name: "Basilic frais", prix_au_kilo: 50 },
  { name: "Tortilla", prix_au_kilo: 8 },
  { name: "Avocat", prix_au_kilo: 13 },
  { name: "Citron", prix_au_kilo: 1 },
  { name: "Œufs", prix_au_kilo: 9 },
...
RecipeIngredient.create!(recipe: recipes_objects[3], ingredient: Ingredient.find_by(name: "Steak haché"), quantity: "300g")
...
RecipeIngredient.create!(recipe: recipes_objects[10], ingredient: Ingredient.find_by(name: "Chapelure"), quantity: "100g")
...
RecipeIngredient.create!(recipe: recipes_objects[5], ingredient: Ingredient.find_by(name: "Wasabi"), quantity: "10g")
...
RecipeIngredient.create!(recipe: recipes_objects[7], ingredient: Ingredient.find_by(name: "Coulis de tomate"), quantity: "100g")
...
RecipeIngredient.create!(recipe: recipes_objects[11], ingredient: Ingredient.find_by(name: "Nuoc mam"), quantity: "2 c.à.s")
...
RecipeIngredient.create!(recipe: recipes_objects[12], ingredient: Ingredient.find_by(name: "Guanciale"), quantity: "50g")

# Pâtes à l'arrabiata
RecipeIngredient.create!(recipe: recipes_objects[13], ingredient: Ingredient.find_by(name: "Spaghetti"), quantity: "200g")
...
RecipeIngredient.create!(recipe: recipes_objects[13], ingredient: Ingredient.find_by(name: "Paprika"), quantity: "1 c.à.c")
RecipeIngredient.create!(recipe: recipes_objects[13], ingredient: Ingredient.find_by(name: "Chorizo"), quantity: "100g")

# Salade de pâtes à la Julio
RecipeIngredient.create!(recipe: recipes_objects[14], ingredient: Ingredient.find_by(name: "Spaghetti"), quantity: "150g")
...
RecipeIngredient.create!(recipe: recipes_objects[18], ingredient: Ingredient.find_by(name: "Roquette"), quantity: "100g")
RecipeIngredient.create!(recipe: recipes_objects[18], ingredient: Ingredient.find_by(name: "Graines de courge"), quantity: "10g")
...
RecipeIngredient.create!(recipe: recipes_objects[22], ingredient: Ingredient.find_by(name: "Farine de sarrasin"), quantity: "100g")
...
RecipeIngredient.create!(recipe: recipes_objects[23], ingredient: Ingredient.find_by(name: "Paprika"), quantity: "1 càs")
...
# Bœuf bourguignon
RecipeIngredient.create!(recipe: recipes_objects[28], ingredient: Ingredient.find_by(name: "Bœuf"), quantity: "600g")
